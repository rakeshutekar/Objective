---
name: objective
description: Use when the user asks Claude to track work in Objective, create or claim tickets, coordinate multiple agents, update implementation status, claim files before editing, record tests, attach proof artifacts, or complete tickets with evidence.
---
